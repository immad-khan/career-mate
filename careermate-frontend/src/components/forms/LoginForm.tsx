      ...
      >
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          >
            ...
            <span className={`text-xs font-medium ${selectedRole === "job_seeker" ? "text-purple-700" : "text-gray-600"}`}>
              Job Seeker
            </span>
          </button>
          <button
          ...
          >
            <span className="text-2xl mb-1">💼</span>
            <span className={`text-xs font-medium ${selectedRole === "hr" ? "text-purple-700" : "text-gray-600"}`}>
              HR
            </span>
          </button>
          <button
          ...
          >
            <span className="text-2xl mb-1">👑</span>
            <span className={`text-xs font-medium ${selectedRole === "admin" ? "text-purple-700" : "text-gray-600"}`}>
              Admin
            </span>
          </button>
        </div>
