...
import { BaytCrawler } from './BaytCrawler.js';
import { BrightspyreCrawler } from './BrightspyreCrawler.js';
...
export class JobCrawler {
    constructor(options = {}) {
        ...
        this.crawlers = {
            ...
            bayt: new BaytCrawler(this.options),
            brightspyre: new BrightspyreCrawler(this.options)
        };
